...
import com.liferay.assignment.office.model.impl.DepartmentImpl;
import com.liferay.assignment.office.model.impl.DepartmentModelImpl;
import com.liferay.assignment.office.service.persistence.DepartmentPersistence;
import com.liferay.assignment.office.service.persistence.impl.constants.officesPersistenceConstants;
...
public class DepartmentPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByName_department;
	private FinderPath _finderPathWithoutPaginationFindByName_department;
	private FinderPath _finderPathCountByName_department;
	 ...
	 */
	@Override
	public List<Department> findByName_department(
		String deptName, long departmentId) {

		return findByName_department(
			deptName, departmentId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<Department> findByName_department(
		...
		return findByName_department(deptName, departmentId, start, end, null);
	}
	...
	public List<Department> findByName_department(
		...
		return findByName_department(
			deptName, departmentId, start, end, orderByComparator, true);
	}
	...
	public List<Department> findByName_department(
		...
		deptName = Objects.toString(deptName, "");
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByName_department;
				finderArgs = new Object[] {deptName, departmentId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByName_department;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			if (deptName.isEmpty()) {
				sb.append(_FINDER_COLUMN_NAME_DEPARTMENT_DEPTNAME_3);
			}
			else {
				bindDeptName = true;

				sb.append(_FINDER_COLUMN_NAME_DEPARTMENT_DEPTNAME_2);
			}

			sb.append(_FINDER_COLUMN_NAME_DEPARTMENT_DEPARTMENTID_2);
	...
	public Department findByName_department_First(
		...
		Department department = fetchByName_department_First(
	...
	public Department fetchByName_department_First(
		...
		List<Department> list = findByName_department(
			deptName, departmentId, 0, 1, orderByComparator);
	...
	public Department findByName_department_Last(
		...
		Department department = fetchByName_department_Last(
			deptName, departmentId, orderByComparator);
	...
	public Department fetchByName_department_Last(
		...
		int count = countByName_department(deptName, departmentId);
		...
		List<Department> list = findByName_department(
			deptName, departmentId, count - 1, count, orderByComparator);
	...
	public void removeByName_department(String deptName, long departmentId) {
		for (Department department :
				findByName_department(
					deptName, departmentId, QueryUtil.ALL_POS,
	...
	public int countByName_department(String deptName, long departmentId) {
		...
		FinderPath finderPath = _finderPathCountByName_department;

		Object[] finderArgs = new Object[] {deptName, departmentId};
	...
	private static final String _FINDER_COLUMN_NAME_DEPARTMENT_DEPTNAME_2 =
		"department.deptName = ? AND ";

	private static final String _FINDER_COLUMN_NAME_DEPARTMENT_DEPTNAME_3 =
		"(department.deptName IS NULL OR department.deptName = '') AND ";

	private static final String _FINDER_COLUMN_NAME_DEPARTMENT_DEPARTMENTID_2 =
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByName_department = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByName_department",
			new String[] {
				String.class.getName(), Long.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
			},
			new String[] {"deptName", "departmentId"}, true);

		_finderPathWithoutPaginationFindByName_department = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByName_department",
			new String[] {String.class.getName(), Long.class.getName()},
			new String[] {"deptName", "departmentId"}, true);

		_finderPathCountByName_department = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByName_department",
			new String[] {String.class.getName(), Long.class.getName()},
			new String[] {"deptName", "departmentId"}, false);
	}
	...
	@Override
	@Reference(
		target = officesPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = officesPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
