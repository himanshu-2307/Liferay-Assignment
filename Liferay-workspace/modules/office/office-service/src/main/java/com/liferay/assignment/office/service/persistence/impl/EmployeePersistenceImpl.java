...
import com.liferay.assignment.office.exception.NoSuchEmployeeException;
import com.liferay.assignment.office.model.Employee;
import com.liferay.assignment.office.model.impl.EmployeeImpl;
import com.liferay.assignment.office.model.impl.EmployeeModelImpl;
import com.liferay.assignment.office.service.persistence.EmployeePersistence;
...
public class EmployeePersistenceImpl
	 ...
	 */
	@Override
	public List<Employee> findByName_salary(String name, long salary) {
	...
	public Employee[] findByName_salary_PrevAndNext(
			long employeeId, String name, long salary,
			OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {
	 ...
	 */
	@Override
	public void removeByName_salary(String name, long salary) {
		for (Employee employee :
				findByName_salary(
					name, salary, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	 ...
	 */
	@Override
	public int countByName_salary(String name, long salary) {
		name = Objects.toString(name, "");
