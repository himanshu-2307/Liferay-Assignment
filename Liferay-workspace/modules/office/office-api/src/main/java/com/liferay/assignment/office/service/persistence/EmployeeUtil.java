...
public class EmployeeUtil {
	...
	public static Employee findByUuid_First(
		...
		throws com.liferay.assignment.office.exception.NoSuchEmployeeException {
	 ...
	 * @return the matching employees
	 */
	public static List<Employee> findByName_salary(String name, long salary) {
	...
	public static Employee[] findByName_salary_PrevAndNext(
		...
		return getPersistence().findByName_salary_PrevAndNext(
			employeeId, name, salary, orderByComparator);
	}
	 ...
	 * @param salary the salary
	 */
	public static void removeByName_salary(String name, long salary) {
	 ...
	 * @return the number of matching employees
	 */
	public static int countByName_salary(String name, long salary) {
