...
public interface ProjectService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.assignment.office.service.impl.ProjectServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the project remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProjectServiceUtil} if injection and service tracking are not available.
	 */
